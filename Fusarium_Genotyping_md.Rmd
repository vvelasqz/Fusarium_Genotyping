...
We start by opening the files and set up thresholds for antimycotic susceptibility:
...
We build a function to test the enrichment of different characteristicas acorss the molecular identification of the isolates
...
```{r AMOVA, echo=TRUE, message=FALSE, warning=FALSE}
#AMOVA
library("adegenet")
library("pegas")
library("mmod")
